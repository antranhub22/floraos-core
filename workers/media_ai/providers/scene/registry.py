...
def thu_tu_nha_cung_cap(uu_tien: str | None = None) -> list[SceneProvider]:
    cau_hinh = [t.strip().lower() for t in (os.environ.get("VARIANT_PROVIDER_ORDER") or "").split(",") if t.strip()]
