...
| `compose_mode` | `paste \| harmonize`, mặc định `paste` | Đợt 3. `harmonize`: màu bóng lấy từ hậu cảnh, hậu cảnh làm mờ nhẹ khi sắc hơn bó hoa, light wrap 0,42 trong đúng dải viền 4 px — không đụng lõi đo (`image/hoa_hop.py`) |
