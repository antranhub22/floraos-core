...
/**
 * Dọn sạch hai mươi mốt bảng nền giữa các trường hợp thử (bảy của P1, hai
 * bảng quyền của P2, năm bảng Asset/Job/Usage/Audit của P3, hai bảng Hồ sơ
 * của P4, năm bảng Product Master/Analysis của P5). Bộ test cách ly phải bắt
 * đầu từ một cơ sở dữ liệu rỗng, nếu không thì "không tìm thấy" có thể là do
 * dữ liệu sót lại chứ không do bộ gác.
 */
